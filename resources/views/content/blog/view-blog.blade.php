...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <img src="{{asset($blog_details->image)}}" alt="blog-image" id="blogDetailsImage">
        </div>
    </div>
        ...
        <div class="col-12 px-3 py-3">
            <div class="d-flex flex-row align-items-center justify-content-between">
                <p class="text-primary">
                    <strong>Posted on: {{Carbon\Carbon::parse($blog_details->created_at)->format('M-d, Y')}}</strong>
                </p>
                <p>
            ...
            <h3 class="mt-2">{{$blog_details->title}}</h3>
        </div>
