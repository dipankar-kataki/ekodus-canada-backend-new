    ...
    <div class="row">
        @forelse ($products as $item)
            <div class="col-md-4 col-sm-12">
                <div class="card mb-3">
                    <img src="{{asset($item->image)}}" class="card-img-top" alt="Product Image" style="height:250px;object-fit:cover;">
                    <div class="card-body" style="border: 1px solid #f4f4f4;">
                        ...
                        <div class="d-flex flex-row-reverse align-items-center">
                            <a href="{{route('admin.product.details',['id' => encrypt($item->id)])}}" class="btn btn-md btn-primary mx-3">View</a>
                            <a href="{{route('admin.edit.product.page',['id' => encrypt($item->id)])}}" class="btn btn-md btn-warning">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
        @empty
            <div class="mx-auto flex-row justify-content-around align-items-center">
                <h5>Oops! No Products To Show.</h5>
            </div>
        @endforelse
    </div>
@endsection
