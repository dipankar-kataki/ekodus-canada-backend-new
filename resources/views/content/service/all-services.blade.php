    ...
    <div class="row">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body" style="border: 1px solid #f4f4f4;">
                        ...
                        <div class="d-flex flex-row-reverse align-items-center">
                            <a href="{{route('admin.service.details',['id' => encrypt($item->id)])}}" class="btn btn-md btn-primary mx-3">View</a>
                            <a href="{{route('admin.edit.service.page',['id' => encrypt($item->id)])}}" class="btn btn-md btn-warning">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
        @empty
            <div class="mx-auto flex-row justify-content-around align-items-center">
                <h5>Oops! No Services To Show.</h5>
            </div>
        @endforelse
    </div>
@endsection
